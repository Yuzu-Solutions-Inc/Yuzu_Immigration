    ...
    <main className="landing-page relative flex min-h-full flex-1 flex-col overflow-x-hidden bg-[var(--paper-500)]">
      ...
      <section className="relative isolate overflow-hidden bg-[var(--carbon-700)] text-white">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(ellipse 80% 60% at 15% 20%, rgba(52,152,219,0.32), transparent 55%), radial-gradient(ellipse 70% 50% at 85% 10%, rgba(52,152,219,0.2), transparent 50%), radial-gradient(ellipse 60% 40% at 70% 80%, rgba(255,159,67,0.14), transparent 55%), linear-gradient(180deg, #1F2426 0%, #0F1213 55%, #1F2426 100%)",
          }}
        />
        <div
          aria-hidden
      ...
      <section className="relative overflow-hidden bg-[var(--carbon-700)] py-20 text-white sm:py-24">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(ellipse 70% 80% at 50% 120%, rgba(52,152,219,0.38), transparent 60%)",
          }}
        />
