...
async function main() {
  ...
  console.log("   in .env.local and Vercel Production, then redeploy.");
  console.log("2. Remove DOCUMENT_ENCRYPTION_KEY_ROTATE.");
  console.log("3. Store the new key in your password manager. Destroy the old wrap key.");
}
