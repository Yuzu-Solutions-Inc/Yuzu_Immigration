# Langage de consentement et de mandat (cabinets)

À insérer dans votre contrat de service ou un formulaire distinct. Faites adapter le texte par un conseiller. Les cases **ne doivent pas** être précochées. Au Québec, pour les renseignements sensibles, le consentement doit être **exprès**, spécifique et demandé en termes clairs.
...
☐ Je suis autorisé(e) à fournir des renseignements sur les membres de la famille suivants : [noms].  
☐ Pour chaque enfant de **moins de 14 ans**, je suis parent ou tuteur (ou autrement autorisé par la loi) et je consens à la collecte de ses renseignements pour ce dossier.
...
☐ Je comprends que certains fournisseurs peuvent traiter des renseignements **hors Québec**, y compris aux États-Unis, comme l’explique l’avis du cabinet, et j’accepte cette communication pour les fins ci-dessus.

## E. Refus et retrait

Je peux refuser une case. Le cabinet pourrait alors être dans l’impossibilité d’offrir le service lié. Je peux retirer mon consentement en écrivant à [courriel du cabinet], sous réserve du délai de six ans et des autres devoirs légaux.
