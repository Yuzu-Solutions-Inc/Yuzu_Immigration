...
- Your **consulting firm** decides why client information is collected and is responsible for the immigration file (consent, retainers, College duties, notices to clients).
- **Yuzu Solutions Inc.** runs the software. We process client information on the firm’s instructions. We are responsible for how we protect the platform and for staff-account information we use to operate it.

## What we protect

Immigration files can include names, contact details, passports, questionnaires, supporting documents, notes, bookings, and information about family members (including minors). We treat that as sensitive.
