-- Fix undeclared v_slug in purge, and lock analytics tombstones behind RLS.
-- Service role bypasses RLS; anon/authenticated have no grants or policies.

alter table private.deleted_organization_entities enable row level security;
